...
public:
  ...
  void SetRawResA(Float_t RawresA);
  void SetRawRespower(Float_t Rawrespower);
  ...
  Float_t GetRespower() const {return respower;};
   ...
   using   CDetectors::GetRawResA;
  Float_t GetRawResA() const {return RawresA;};
  using   CDetectors::GetRawRespower;
  Float_t GetRawRespower() const {return Rawrespower;};
