...
int main()
{
  ...
  int nworkers = (int)2*max_workers/3.;
  ...
  TString folder_name = "FROZEN/N-SI-125/";//"FROZEN/Test/";//"nuball2/Calibrations/";//"FROZEN/PoC/";
  TString Runlist_filename = "listerun_nearline.dat";//"listerun_calib_Time.dat";//"listerun_calib_NRJ.dat";
  ...
  Bool_t isCalculating_T_Calibration = kTRUE;
